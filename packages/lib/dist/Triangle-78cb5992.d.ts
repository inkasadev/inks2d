...
declare class Circle extends DisplayObject {
    ...
    endAngle: number;
    isPie: boolean;
    constructor(width?: number, height?: number, fillStyle?: string, strokeStyle?: string, lineWidth?: number);
    get diameter(): number;
...
declare class Triangle extends DisplayObject {
    ...
    constructor(width?: number, height?: number, inclination?: "right" | "left", fillStyle?: string, strokeStyle?: string, lineWidth?: number, position?: Point);
