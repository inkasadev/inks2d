...
declare class ParticleSystem {
     ...
     *
     */
    constructor(source: () => DisplayObject, position?: Point, gravity?: Point, numParticles?: number, randomSpacing?: boolean, minAngle?: number, maxAngle?: number, minSize?: number, maxSize?: number, minSpeed?: number, maxSpeed?: number, minScaleSpeed?: number, maxScaleSpeed?: number, minAlphaSpeed?: number, maxAlphaSpeed?: number, minRotationSpeed?: number, maxRotationSpeed?: number, maxInteractions?: number);
